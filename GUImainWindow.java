...
public class GUImainWindow extends JFrame {
	...
	public GUImainWindow () {
		...
		btnNewButton_27.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				GUIconfirmDialog1 confirmD = new GUIconfirmDialog1(GUImainWindow.this, Dialog.ModalityType.DOCUMENT_MODAL);
			}
		});
		btnNewButton_16.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				GUIconfirmDialog confirmD = new GUIconfirmDialog(GUImainWindow.this, Dialog.ModalityType.DOCUMENT_MODAL);
